...
function Pencil(ctx, drawing, canvas) {
	...
	}.bind(this); //équivalent à déclarer une fonction avec prototype

	this.onInteractionUpdate = function(dnd){
		if(this.currEditingMode === editingMode.rect){
			this.currentShape = new Rectangle(this.currColour, this.currLineWidth, dnd.initialPositionX, dnd.initialPositionY, 
				(dnd.finalPositionX -dnd.initialPositionX), dnd.finalPositionY-dnd.initialPositionY );
		}else{
			this.currentShape = new Line(this.currColour, this.currLineWidth, dnd.initialPositionX, dnd.initialPositionY, dnd.finalPositionX, dnd.finalPositionY);
		}
